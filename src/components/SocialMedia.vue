...
const props = defineProps({
  ...
  socialLinks: {
    ...
    default: () => [
      { 
        name: 'LinkedIn', 
        url: 'https://www.linkedin.com/in/wgalleti/', 
      ...
      { 
        name: 'Instagram', 
        url: 'https://www.instagram.com/wgalleti/', 
      ...
      { 
        name: 'YouTube', 
        url: 'https://www.youtube.com/@wGalleti', 
    ...
    <div class="card" data-sr-left>
      ...
      <div class="flex flex-wrap justify-center gap-6">
        <a 
          ...
          class="flex flex-col items-center p-4 rounded-lg bg-purple-50 dark:bg-gray-700 transition-all duration-300 hover:transform hover:scale-105 hover:shadow-lg"
