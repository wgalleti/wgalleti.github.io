...
<template>
  <div class="min-h-screen flex flex-col relative noise-overlay">
    ...
    <a
      ...
      target="_blank"
      rel="noopener"
      class="fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-emerald-500 text-white shadow-lg shadow-emerald-500/30 transition-all duration-300 hover:scale-110 hover:bg-emerald-400 active:scale-95 md:hidden"
      title="WhatsApp"
